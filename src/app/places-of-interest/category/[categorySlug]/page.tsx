// app/places-of-interest/category/[categorySlug]/page.tsx
'use client';
  ...
  return (
    <section className="bg-gradient-to-b from-blue-50/30 via-white to-gray-50 min-h-screen">
      ...
      <div className="lg:mx-[7%] mx-[4%] font-sans pb-12">
        ...
        {/* Header */}
        <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-3xl p-8 lg:p-12 text-white shadow-2xl mb-8 relative overflow-hidden">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <select
              ...
              className="flex-1 sm:max-w-xs p-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500"
            >
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {monuments.map((monument, index) => (
                <div
                  key={`${monument.city}-${index}`}
                  onClick={() => router.push(`/places-of-interest/monument/${monument.city}`)}
                ...
                >
                  {/* Image Placeholder */}
                  <div className="relative h-56 bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100">
            ...
            {hasMore && (
              <div className="flex justify-center mt-8">
                <button
                  ...
                  className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-lg hover:shadow-xl"
                >
                  {loadingMore ? (
                    <>
