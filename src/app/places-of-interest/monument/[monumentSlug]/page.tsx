// app/places-of-interest/monument/[monumentSlug]/page.tsx
'use client';
...
import placesOfInterestAPI, { MonumentDetails, Monument } from '@/lib/api/places-of-interest.api';
...
export default function MonumentDetailPage() {
    ...
    console.log(monumentSlug, "monument slug");
    ...
    useEffect(() => {
        const fetchMonumentData = async () => {
            try {
                ...
                setError(err instanceof Error ? err.message : 'Failed to load monument details');
            } finally {
                setLoading(false);
            }
        };
        ...
        return (
            <section className="bg-gradient-to-b from-blue-50/30 to-white min-h-screen">
                ...
                <div className="flex flex-col items-center justify-center h-[70vh] gap-4">
                    ...
                    <p className="text-gray-600 text-lg font-medium">Loading monument details...</p>
                </div>
            </section>
        );
    }
            ...
            <section className="bg-gradient-to-b from-blue-50/30 to-white min-h-screen">
                ...
                <div className="lg:mx-[7%] mx-[4%] mt-12">
                    <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-8 text-center">
                        <h2 className="text-2xl font-bold text-red-600 mb-2">Monument Not Found</h2>
    ...
    return (
        <section className="bg-gradient-to-b from-blue-50/30 via-white to-gray-50 min-h-screen">
            ...
            <div className="text-sm text-gray-600 lg:mb-6 mb-4 md:mt-6 mt-3 lg:mx-[7%] mx-[4%]">
                ...
                <span className="mx-2">→</span>
                <span className="text-blue-600 font-semibold">{monument.monumentName}</span>
            </div>
            ...
            <div className="lg:mx-[7%] mx-[4%] font-sans space-y-8 pb-12">
                ...
                {/* Hero Section */}
                <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-3xl p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
                            ...
                            {monument.rating && (
                                <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                                    ...
                                    {monument.totalRatings && (
                                        <span className="text-sm">({monument.totalRatings})</span>
                                    )}
                                </div>
                            )}
                        </div>

                        <h1 className="text-4xl lg:text-6xl font-bold mb-4">{monument.monumentName}</h1>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {monument.description && (
                            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                                ...
                                <p className="text-gray-700 leading-relaxed">{monument.description}</p>
                            </div>
                        )}
                            ...
                            <div className="space-y-3">
                                {monument.openingtime && (
                                    <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                                        ...
                                        <div>
                                            <p className="font-semibold text-gray-900">Opening Time</p>
                                ...
                                {monument.clossingtime && (
                                    <div className="flex items-start gap-3 p-3 bg-red-50 rounded-lg">
                                        ...
                                        <div>
                                            <p className="font-semibold text-gray-900">Closing Time</p>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                {monument.entryFees.indianAdult > 0 && (
                                    <div className="p-4 bg-blue-50 rounded-lg">
                                        ...
                                        <p className="text-xl font-bold text-gray-900">₹{monument.entryFees.indianAdult}</p>
                                    </div>
                                )}
                                {monument.entryFees.foreignAdult > 0 && (
                                    <div className="p-4 bg-purple-50 rounded-lg">
                                        <p className="text-sm text-gray-600">Foreign Adult</p>
                                        <p className="text-xl font-bold text-gray-900">₹{monument.entryFees.foreignAdult}</p>
                                    </div>
                                )}
                                {monument.entryFees.indianChild > 0 && (
                                    <div className="p-4 bg-green-50 rounded-lg">
                                        <p className="text-sm text-gray-600">Indian Child</p>
                                        <p className="text-xl font-bold text-gray-900">₹{monument.entryFees.indianChild}</p>
                                    </div>
                                )}
                                {monument.entryFees.foreignChild > 0 && (
                                    <div className="p-4 bg-yellow-50 rounded-lg">
                                        <p className="text-sm text-gray-600">Foreign Child</p>
                                        <p className="text-xl font-bold text-gray-900">₹{monument.entryFees.foreignChild}</p>
                                    </div>
                                )}
                            </div>
                        </div>
                                ...
                                <div className="space-y-4">
                                    {monument.connectivity.road && (
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="font-semibold text-gray-900 mb-1">By Road</p>
                                                <p className="text-gray-700">{monument.connectivity.road}</p>
                                            </div>
                                        </div>
                                    )}
                                    {monument.connectivity.rail && (
                                        <div className="flex items-start gap-3">
                                            <Train className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                                            <div>
                                                <p className="font-semibold text-gray-900 mb-1">By Train</p>
                                                <p className="text-gray-700">{monument.connectivity.rail}</p>
                                            </div>
                                        </div>
                                    )}
                                    {monument.connectivity.air && (
                                        <div className="flex items-start gap-3">
                                            <Plane className="w-6 h-6 text-purple-600 flex-shrink-0 mt-1" />
                                            <div>
                                                <p className="font-semibold text-gray-900 mb-1">By Air</p>
                                                <p className="text-gray-700">{monument.connectivity.air}</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                                ...
                                {monument.location.googleMapUrl && (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="block w-full bg-red-600 hover:bg-red-700 text-white text-center py-3 rounded-lg font-semibold transition mb-3"
                                    >
                                        Open in Google Maps
                                    </a>
                                )}
                                <div className="text-sm text-gray-600 space-y-1">
                                    <p>
                                        <span className="font-medium">Latitude:</span> {monument.location.latitude}
                                    </p>
                                    <p>
                                        <span className="font-medium">Longitude:</span> {monument.location.longitude}
                                    </p>
                                </div>
                            </div>
                        )}
                            ...
                            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                                ...
                                <div className="space-y-3">
                                    <div className="p-3 bg-yellow-50 rounded-lg">
                                        ...
                                        <p className="text-lg font-bold text-gray-900">{monument.weather.temperature}</p>
                                    </div>
                                    <div className="grid grid-cols-3 gap-2 text-center">
                                        <div className="p-2 bg-orange-50 rounded-lg">
                                            <p className="text-xs text-gray-600">Summer</p>
                                            <p className="font-bold text-orange-600">{monument.weather.humiditySummer}%</p>
                                        </div>
                                        <div className="p-2 bg-blue-50 rounded-lg">
                                            <p className="text-xs text-gray-600">Winter</p>
                                            <p className="font-bold text-blue-600">{monument.weather.humidityWinter}%</p>
                                        </div>
                                        <div className="p-2 bg-green-50 rounded-lg">
                                            <p className="text-xs text-gray-600">Monsoon</p>
                                            <p className="font-bold text-green-600">{monument.weather.humidityMonsoon}%</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {nearbyMonuments.map((nearby) => (
                                <div
                                    key={nearby.slug}
                                    onClick={() => router.push(`/places-of-interest/monument/${nearby.slug}`)}
                                ...
                                >
                                    <div className="relative h-48 bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100">
                                        <div className="w-full h-full flex items-center justify-center">
                                            <MapPin className="w-16 h-16 text-blue-300/50" />
                                        </div>
                                    </div>
                                    <div className="p-4">
                                        ...
                                        {nearby.rating && (
                                            <div className="flex items-center gap-1 mt-2">
                                                ...
                                                <span className="text-sm font-semibold">{nearby.rating}/5</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
