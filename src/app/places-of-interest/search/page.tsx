// app/places-of-interest/search/page.tsx
'use client';

import React, { useEffect, useState, Suspense } from 'react';
import { useRouter, useSearchParams } from 'next/navigation';
import NavBar from '@/components/layout/navbar/NavBar';
import { Search, Loader2, MapPin, Clock, Star, Filter, X } from 'lucide-react';
import placesOfInterestAPI, { Monument, Category, State } from '@/lib/api/places-of-interest.api';
...
function SearchResultsContent() {
    ...
    const updateFilter = (type: 'category' | 'state', value: string) => {
        ...
        router.push(`/places-of-interest/search?${params.toString()}`);
    };

    const clearFilters = () => {
        router.push(`/places-of-interest/search?q=${searchQuery}`);
    };
            ...
            <section className="bg-gradient-to-b from-blue-50/30 to-white min-h-screen">
                ...
                <div className="lg:mx-[7%] mx-[4%] mt-12">
                    <div className="bg-yellow-50 border-2 border-yellow-200 rounded-2xl p-8 text-center">
                        ...
                        <p className="text-gray-600 mb-4">Please enter a search term to find monuments</p>
                        <button
        ...
        return (
            <section className="bg-gradient-to-b from-blue-50/30 to-white min-h-screen">
                ...
                <div className="flex flex-col items-center justify-center h-[70vh] gap-4">
                    ...
                    <p className="text-gray-600 text-lg font-medium">Searching for "{searchQuery}"...</p>
                </div>
            </section>
        );
    }
    ...
    return (
        <section className="bg-gradient-to-b from-blue-50/30 via-white to-gray-50 min-h-screen">
            ...
            <div className="text-sm text-gray-600 lg:mb-6 mb-4 md:mt-6 mt-3 lg:mx-[7%] mx-[4%]">
                ...
                <span className="mx-2">→</span>
                <span className="text-blue-600 font-semibold">Search Results</span>
            </div>

            <div className="lg:mx-[7%] mx-[4%] font-sans pb-12">
                {/* Header */}
                <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-3xl p-8 lg:p-12 text-white shadow-2xl mb-8">
                    ...
                    <div className="lg:col-span-3">
                        {error ? (
                            <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-8 text-center">
                                <h3 className="text-xl font-bold text-red-600 mb-2">Search Error</h3>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {monuments.map((monument) => (
                                        <div
                                            key={monument.slug}
                                            onClick={() =>
                                                router.push(`/places-of-interest/monument/${monument.slug}`)
                                            }
