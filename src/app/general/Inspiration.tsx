...
import { getInspirationalTours } from '@/services/inspirationService';
              ...
              {getActiveTours().map((tour, index) => (
                ...
                >
                  <div className="relative h-48 w-full">
                    <Image src={Bridge} alt={tour.title} fill className="object-cover" />
                  </div>
                  <div className="p-4">
                    <h3 className="text-lg font-semibold mb-2 line-clamp-2">{tour.title}</h3>
                    <p className="text-gray-600 text-sm line-clamp-3 mb-3">{tour.description}</p>
                    <button
