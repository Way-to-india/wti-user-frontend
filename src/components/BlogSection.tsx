...
const BlogSection = () => {
    ...
    const fetchBlogData = async () => {
        try {
            ...
            if (postsResponse.success && postsResponse.data) {
                ...
                const filteredPosts = featuredResponse.data && featuredResponse.data.id
    ...
    return (
        <section className="container mx-auto my-12 md:my-16 px-4 md:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-carrot-orange mb-6 text-center md:text-left">Latest WaytoIndia Travel Blogs</h2>
            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {featuredPost && (
                        <div className="relative">                            <div className='relative h-64 md:h-80'>
                                {featuredPost.image ? (
                                    <Image 
